...
export default function ContactHero({ setting }: Props) {
  ...
  const splitAt = Math.ceil(words.length * 0.55);
  ...
  return (
    <PageHero
      breadcrumb={[
        { label: locale === "bn" ? "যোগাযোগ" : "Contact" },
      ]}
      ...
      ctas={[
        ...
        ...(whatsappHref
          ? [
              {
                label: t("contact.hero.ctaWhatsapp"),
                href: whatsappHref,
